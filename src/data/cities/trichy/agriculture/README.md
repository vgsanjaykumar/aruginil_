...
To add a real, verified business in this group for Trichy, create a file named
...
export const trichyAgroServicesBusinesses: Business[] = [
  {
    id: "trichy-CATEGORY_SLUG-your-business-slug",
