...
export const aruppukottaiEarthMoversBusinesses: Business[] = [
  {
...
```ts
import { yourEarthMoversBusinesses } from "./CATEGORY_SLUG";

export const aruppukottaiHeavyEquipmentBusinesses = [
  ...yourEarthMoversBusinesses,
];
```
