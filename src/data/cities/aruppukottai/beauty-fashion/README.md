...
- `men-s-salons` — Men's Salons
- `unisex-salons` — Unisex Salons
- `makeup-artists` — Makeup Artists
- `bridal-makeup-artists` — Bridal Makeup Artists
- `mehndi-artists` — Mehndi Artists
- `tailoring` — Tailoring
- `aari-works-and-embroidery-works` — Aari Works & Embroidery Works
- `boutiques` — Boutiques
- `tattoo` — Tattoo
...
export const aruppukottaiBeautyParlourBusinesses: Business[] = [
  {
...
```ts
import { yourBeautyParlourBusinesses } from "./CATEGORY_SLUG";

export const aruppukottaiBeautyFashionBusinesses = [
  ...yourBeautyParlourBusinesses,
];
```
