...
- `marakkadai` — Marakkadai
- `timber-dealers` — Timber Dealers
- `saw-mills` — Saw Mills
- `temple-works` — Temple Works
- `sirpakkalaikoodam` — Sirpakkalaikoodam
...
export const aruppukottaiWoodWorksBusinesses: Business[] = [
  {
...
```ts
import { yourWoodWorksBusinesses } from "./CATEGORY_SLUG";

export const aruppukottaiWoodFurnitureBusinesses = [
  ...yourWoodWorksBusinesses,
];
```
