...
- `fish-retailers` — Fish Retailers
- `fish-aquarium` — Fish Aquarium
- `chicken-shops` — Chicken Shops
- `mutton-shops` — Mutton Shops
...
export const aruppukottaiFishRetailersBusinesses: Business[] = [
  {
...
```ts
import { yourFishRetailersBusinesses } from "./CATEGORY_SLUG";

export const aruppukottaiFishMeatBusinesses = [
  ...yourFishRetailersBusinesses,
];
```
