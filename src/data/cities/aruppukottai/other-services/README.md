...
export const aruppukottaiSpaBusinesses: Business[] = [
  {
...
```ts
import { yourSpaBusinesses } from "./CATEGORY_SLUG";

export const aruppukottaiOtherServicesBusinesses = [
  ...yourSpaBusinesses,
];
```
