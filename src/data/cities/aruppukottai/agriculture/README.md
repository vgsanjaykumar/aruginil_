# Aruppukottai — Agriculture

To add a real, verified business in this group for Aruppukottai, create a file named
...
- `agri-clinics` — Agri Clinics
- `nursery-gardens` — Nursery Gardens
- `seed-dealers` — Seed Dealers
- `fertilizer-dealers` — Fertilizer Dealers
- `pesticide-dealers` — Pesticide Dealers
- `agricultural-equipment-dealers` — Agricultural Equipment Dealers
- `tractor-dealers` — Tractor Dealers
- `tractor-repair` — Tractor Repair
- `drip-irrigation-dealers` — Drip Irrigation Dealers
- `farm-equipment` — Farm Equipment
- `agricultural-machinery` — Agricultural Machinery
- `cattle-feed-dealers` — Cattle Feed Dealers
- `areca-leaf-plates` — Areca Leaf Plates
...
export const aruppukottaiAgroServicesBusinesses: Business[] = [
  {
    id: "aruppukottai-CATEGORY_SLUG-your-business-slug",
    name: "Real Business Name",
    slug: "your-business-slug",
    city: "Aruppukottai",
    citySlug: "aruppukottai",
...
1. Add it to this folder's `index.ts` (create that file too if this is the
   first category with data in this group for Aruppukottai):

```ts
import { yourAgroServicesBusinesses } from "./CATEGORY_SLUG";

export const aruppukottaiAgricultureBusinesses = [
  ...yourAgroServicesBusinesses,
];
```

2. Add the group import + spread to `src/data/businesses.ts` (only if this is
   the first category with data in this group for Aruppukottai — if the
   group already has other categories with data there, it's already wired in).

3. If `Aruppukottai` doesn't already support this category in
