...
- `borewells` — Borewells
- `borewell-drilling-contractors` — Borewell Drilling Contractors
- `irrigation-works` — Irrigation Works
- `septic-tank-cleaning` — Septic Tank Cleaning
...
export const aruppukottaiRoWaterPurifierBusinesses: Business[] = [
  {
...
```ts
import { yourRoWaterPurifierBusinesses } from "./CATEGORY_SLUG";

export const aruppukottaiWaterCleaningBusinesses = [
  ...yourRoWaterPurifierBusinesses,
];
```
