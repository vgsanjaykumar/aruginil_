# Aruppukottai — Metal Fabrication
...
- `ss-fabrication-works` — SS Fabrication Works
- `aluminium-fabrication` — Aluminium Fabrication
- `steel-fabrication` — Steel Fabrication
- `steel-dealers` — Steel Dealers
- `fencing-works` — Fencing Works
- `grill-works` — Grill Works
- `engineering-works` — Engineering Works
- `rolling-shutters` — Rolling Shutters
- `tinkering-works` — Tinkering Works
- `stone-cutting` — Stone Cutting
- `kallupattarai` — Kallupattarai
...
export const aruppukottaiWeldingWorksBusinesses: Business[] = [
  {
...
```ts
import { yourWeldingWorksBusinesses } from "./CATEGORY_SLUG";

export const aruppukottaiMetalFabricationBusinesses = [
  ...yourWeldingWorksBusinesses,
];
```
