# Dindigul — Agriculture

To add a real, verified business in this group for Dindigul, create a file named
...
export const dindigulAgroServicesBusinesses: Business[] = [
  {
    id: "dindigul-CATEGORY_SLUG-your-business-slug",
