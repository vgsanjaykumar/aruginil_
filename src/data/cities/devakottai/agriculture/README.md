# Devakottai — Agriculture

To add a real, verified business in this group for Devakottai, create a file named
...
export const devakottaiAgroServicesBusinesses: Business[] = [
  {
    id: "devakottai-CATEGORY_SLUG-your-business-slug",
