...
To add a real, verified business in this group for Salem, create a file named
...
export const salemAgroServicesBusinesses: Business[] = [
  {
    id: "salem-CATEGORY_SLUG-your-business-slug",
